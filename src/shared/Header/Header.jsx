...
const Header = () => {
  ...
  return (
    <div className="flex justify-between h-16 text-white  items-center px-6 lg:px-16 py-3 lg:py-0 shadow-lg fixed top-0 right-0 left-0 bg-[#313641] z-40">
      <div>
        <Link to={"/"}>
          {" "}
      ...
      <div
        className={` block lg:flex lg:w-[65%] justify-end items-center px-16 lg:px-0 py-28 lg:py-0  z-40 lg:bg-inherit  lg:static transition-all duration-700  ${
